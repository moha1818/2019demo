...
/**
 * Created by batwings on 16/01/11.
 */
...
public class Lang3Demo {
    ...
    public void stringEscapeUtilsDemo() {
        ...
        System.out.println("html:" + StringEscapeUtils.escapeHtml("/n\n"));
    ...
    public static void main(String[] args) {
        ...
        lang3Demo.charSetDemo();
        lang3Demo.charSetUtilsDemo();
        lang3Demo.objectUtilsDemo();
        lang3Demo.serializationUtilsDemo();
        lang3Demo.randomStringUtilsDemo();
        lang3Demo.stringUtilsDemo();
        lang3Demo.systemUtilsDemo();
        lang3Demo.classUtilsDemo();
        lang3Demo.stringEscapeUtilsDemo();
        lang3Demo.builderDemo();
        lang3Demo.numberUtils();
        lang3Demo.dateFormatUtilsDemo();

        String a = null;
        System.out.println(String.valueOf(StringUtils.isEmpty(a)));
    }
}

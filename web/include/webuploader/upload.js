(function ($) {
    var $wrap = $('#uploader'),
        ...
        uploader;
    // 当domReady的时候开始初始化
    $("#carouselImg").on("shown.bs.modal", function () {
        ...
        uploader.on('uploadSuccess', function (file, json) {
            if (json.returnStatus != '1') {
                ...
                $('#tmpimgid').val(json.keyValue);
                $('#tmpurlid').val(json.returnMsg);
            }
    ...
    $('#carouselImg').on('hide.bs.modal', function () {
        alert("销毁");
        // $("#responeseText").text("");
        uploader.destroy();
    });
